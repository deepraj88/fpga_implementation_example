...
set rt::rc [catch {
  uplevel #0 {
    ...
    set ::env(RT_TMP) "./.Xil/Vivado-4624-deepraj-Aurora-R4/realtime/tmp"
    ...
    if {$rt::useElabCache == false} {
      rt::read_verilog /media/deepraj/Work/workspace/Lecture/Hardwar_security/homework/rotate/rotate.srcs/sources_1/new/rotate_fpga.v
...
# MODE: 
    ...
    rt::set_parameter enableSplitFlowPath "./.Xil/Vivado-4624-deepraj-Aurora-R4/"
